...
export function SectionFourContact() {
  return (
    <section className="px-6 py-10 sm:px-10 lg:px-12">
      <div className="premium-section relative px-6 py-16 sm:px-10 lg:px-20 lg:py-20">
        <div className="absolute left-0 top-0 h-full w-full rounded-[2rem] bg-[radial-gradient(circle_at_20%_10%,rgba(157,100,255,0.16),transparent_36%)]" />
        <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
          ...
          <h2 className="mt-7 text-4xl font-extrabold leading-tight text-[#efe3ff] sm:text-5xl">{sectionFour.title}</h2>

          <p className="mt-8 text-2xl font-semibold text-[#bca4e6] sm:text-3xl">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              ...
              className="inline-flex rounded-full border border-white/10 bg-[#2b213d] px-9 py-4 text-xl font-extrabold text-[#efe3ff] transition-colors hover:bg-[#3b2f54]"
            >
