    ...
    <section className="px-6 pb-10 pt-10 sm:px-10 lg:px-12">
      <div className="premium-section grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className="space-y-8">
          ...
          <h1 className="max-w-xl text-5xl font-extrabold leading-[1.05] text-[#efe3ff] sm:text-6xl">{sectionOne.title}</h1>
          <p className="max-w-xl text-xl leading-relaxed text-[#bda5e9] sm:text-2xl">{sectionOne.subtitle}</p>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <Button
              asChild
              variant="link"
              className="rounded-full border border-[#d8c1ff] px-6 text-lg font-bold text-[#d9c4ff] no-underline"
            >
          ...
          <div className="grid max-w-xl grid-cols-3 gap-3">
            {sectionOne.stats.map((stat) => (
              <article key={stat.label} className="rounded-2xl border border-[#3f2a60] bg-card px-4 py-4">
        ...
        <div className="relative mx-auto w-full max-w-[560px]">
          ...
          <div className="absolute -bottom-5 left-6 flex items-center gap-3 rounded-2xl border border-border bg-card px-4 py-3 shadow-xl">
