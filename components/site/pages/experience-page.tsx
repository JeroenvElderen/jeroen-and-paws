    ...
    <SiteShell activePage="experience">
      <section className="relative isolate min-h-[calc(100svh-4rem)] overflow-hidden bg-[#080b10] px-6 py-16 sm:min-h-[calc(100svh-5rem)] sm:px-8 sm:py-24 lg:py-32">
        ...
        <div className="relative mx-auto max-w-6xl pt-0 sm:pt-8">
          ...
          <h1 className="mt-5 max-w-2xl text-4xl font-semibold leading-tight text-[#fff7e8] sm:text-7xl">More than beautiful care. An unforgettable day with <span className="text-[#a78bfa]">your dog.</span></h1>
          <p className="mt-7 max-w-md text-base leading-7 text-[#f5e9d5] sm:text-lg sm:leading-8">From the first message to the final update, I&apos;m here to make the experience as special as the memories we create together.</p>
          <ButtonLink href="/contact" className="mt-8 sm:mt-9">Discover the experience</ButtonLink>
        </div>
      </section>
