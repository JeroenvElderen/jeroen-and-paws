...
export function ServiceArea() {
  return (
    <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
      <div className="flex min-h-[350px] items-center justify-center rounded-3xl bg-gradient-to-br from-purple-100 to-fuchsia-100">
        <MapPin aria-hidden="true" className="h-20 w-20 text-purple-700/30" />
      </div>
      <div>
