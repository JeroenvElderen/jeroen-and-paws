  ...
  return (
    <section className="bg-[#080b10] px-6 py-14 sm:px-8 lg:py-20">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1fr_0.95fr] lg:items-center">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full bg-[#111821] px-5 py-3 text-sm font-extrabold text-[#d1a34d] shadow-sm">
            <Heart
              aria-hidden="true"
              className="h-4 w-4 fill-[#d1a34d] text-[#d1a34d]"
            />
          ...
          <h1 className="mt-7 text-5xl font-extrabold leading-tight tracking-tight text-[#fff7e8] sm:text-6xl">
            ...
            <span className="block text-[#d1a34d]">companion you love</span>
          </h1>
          <div className="mt-5 h-1 w-72 rounded-full bg-[#d1a34d]/70" />
          ...
          <dl className="mt-10 grid grid-cols-3 gap-5 border-t border-[#d1a34d]/15 pt-6">
            {stats.map((stat) => (
              <div key={stat.label}>
                <dt className="text-3xl font-extrabold text-[#d1a34d] sm:text-4xl">
                  {stat.value}
                </dt>
