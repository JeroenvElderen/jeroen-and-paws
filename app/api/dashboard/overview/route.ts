...
type BookingRow = { id: string; service_name: string | null; starts_at: string | null; ends_at: string | null; status: string | null; portal_clients: { full_name: string | null } | Array<{ full_name: string | null }> | null; portal_dogs: Array<{ name: string | null; profile_photo_url: string | null }> | null };
